...
$(document).ready(function() {
  ...
  var config = {
      type: 'bar',
      data: {
        labels: ['Radar Chart', 'Polar Chart', 'Stepped Chart', 'Lollipop Chart', 'Slope Chart', 'Colume Range', 'Wordcloud'],
        datasets: [{
          label: 'User Vote Counts',
          backgroundColor: window.chartColors.red,
          borderColor: window.chartColors.red,
          data: [
            12,123,45,345,23,232,56,220
          ],
          fill: false,
        },]
      },
...
function onChartSel(val) {
  $('#chart-li'+val).hover(function() {
   owl.trigger('to.owl.carousel', [val,600]);
    }, function(){
  })
}
