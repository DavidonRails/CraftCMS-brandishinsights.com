$(document).ready(function() {
    ...
    /* ======= Scrollspy ======= */
//    $('body').scrollspy({ target: fixedNav, offset: 100});
    ...
    //      if  (fixednav.length) {
	//         var topDistance = $(fixedNav).offset().top;
    //      }
    ...
    $('.play-trigger').on('click', function() {
        ...
        // _wq.push({ id: "0b71j3gpgc", onReady: function(video) {
        //     console.log("I got a handle to the video!", video);
        // }});

        var video = Wistia.api("0b71j3gpgc");
        video.play();
